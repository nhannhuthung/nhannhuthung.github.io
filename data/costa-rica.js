...
images[`${index}`] = [
    {
        ...
        alt: {en: "Front of the 2000 Peso Colon", vi: "Mặt Trước Tờ 2000 Colon"},
        description: {en: "Obverse", vi: "Trước"}
    },
    {
        src: "../images/collection/costa-rica/2018-2019/2000-colon-b.jpg",
        alt: {en: "Back of the 2000 Colon Bill", vi: "Mặt Sau Tờ 2000 Colon"},
        description: {en: "Reverse", vi: "Sau"}
    }
];
slideshowInfo[`${index}`] = {
...
images[`${index}`] = [
    {
        src: "../images/collection/costa-rica/2018-2019/5000-colon-f.jpg",
        alt: {en: "Front of the 5000 Peso Colon", vi: "Mặt Trước Tờ 5000 Colon"},
        description: {en: "Obverse", vi: "Trước"}
    },
    {
        src: "../images/collection/costa-rica/2018-2019/5000-colon-b.jpg",
        alt: {en: "Back of the 5000 Colon Bill", vi: "Mặt Sau Tờ 5000 Colon"},
        description: {en: "Reverse", vi: "Sau"}
    }
];
slideshowInfo[`${index}`] = {
    title: { 
        en: "Costa Rican 5,000 Colones", 
        vi: "5.000 Colon Costa Rica" 
    },
    issuer: {
        en: "Central Bank Of Costa Rica",
        vi: "Ngân Hàng Trung Ương Costa Rica"
...
images[`${index}`] = [
    {
        src: "../images/collection/costa-rica/2018-2019/10000-colon-f.jpg",
        alt: {en: "Front of the 10000 Peso Colon", vi: "Mặt Trước Tờ 10000 Colon"},
        description: {en: "Obverse", vi: "Trước"}
    },
    {
        src: "../images/collection/costa-rica/2018-2019/10000-colon-b.jpg",
        alt: {en: "Back of the 10000 Colon Bill", vi: "Mặt Sau Tờ 10000 Colon"},
        description: {en: "Reverse", vi: "Sau"}
    }
];
slideshowInfo[`${index}`] = {
    title: { 
        en: "Costa Rican 10,000 Colones", 
        vi: "10.000 Colon Costa Rica" 
    },
    issuer: {
        en: "Central Bank Of Costa Rica",
        vi: "Ngân Hàng Trung Ương Costa Rica"
